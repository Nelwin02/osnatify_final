...
?>
    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="container">
						<div class="card">
						<h3 class="card-title text-center">Predict Sickness</h3>
						<div class="card-body">
							<form id="symptomsForm">
							<div class="form-group">
								<label for="symptoms">Enter Symptoms 1</label>
								<input type="text" class="form-control" id="symptoms" placeholder="E.g., fever, cough, headache">
							</div>
							<div class="form-group">
								<label for="symptoms">Enter Symptoms 2</label>
								<input type="text" class="form-control" id="symptoms" placeholder="E.g., fever, cough, headache">
							</div>
							<button type="button" class="btn btn-primary" onclick="predictSickness()">Predict</button>
							</form>
						</div>
						</div>
					</div>
		...
		<script>
    function predictSickness() {
      const symptoms = document.getElementById('symptoms').value;
      console.log('Entered Symptoms:', symptoms);
      // Add your prediction logic here
      alert('Prediction logic goes here!');
    }
  </script>
    </body>
