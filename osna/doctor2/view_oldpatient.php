...
<div class="d-flex mb-4">
    ...
    <a href="oldpatient_prescription.php?username=<?php echo urlencode($username); ?>" class="blue-link">
        <i class="fa fa-plus"></i> Prescription
    </a>&nbsp; &nbsp; &nbsp;


    <a href="oldpatient_printPrescription.php?username=<?php echo urlencode($username); ?>" class="blue-link" style="border-radius: 8px;">
