...
if ($username) {
    ...
    $query = "SELECT symptoms, predicted_disease, predicted_prescription FROM prediction WHERE username = $1 order by created_at desc ";
    $result = pg_query_params($con, $query, [$username]);
                ...
                <form method="POST" action="">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td><textarea class="form-control" name="symptoms" readonly><?php echo htmlspecialchars($symptoms); ?></textarea></td>
                        </tr>
                        <tr>
