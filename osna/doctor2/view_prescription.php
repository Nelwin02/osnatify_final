...
if ($username) {
    ...
    $sql = "SELECT * FROM prediction WHERE username = $1";
...
$sql = "SELECT weight, height, bloodpressure, heartrate FROM vitalsigns WHERE username = $1";
...
$sql = "SELECT predicted_treatment FROM prediction WHERE username = $1";
...
$sql = "SELECT symptoms FROM prediction WHERE username = $1";
...
$sql = "SELECT * FROM doctor_confirm WHERE username = $1 AND date_created::date = CURRENT_DATE ";
