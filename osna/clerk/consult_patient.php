...
// Establish PostgreSQL connection (ensure $con is the connection resource for PostgreSQL)
$sql = "SELECT clerk_name, clerk_image FROM clerk_log WHERE username = $1"; // Using parameterized query to prevent SQL injection
