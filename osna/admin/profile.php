        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <p class="col-sm-10"><?php echo htmlspecialchars($admin['name'] ?? ''); ?></p>
                </div>
            </div>
        </div>
...
$query = "SELECT name, date_birth, admin_email, mobile, admin_address, password 
          FROM admin_log 
          WHERE id = $1";
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <!-- Display the password as '********' to maintain security -->
                                <input type="password" class="form-control" name="new_password" value="********" readonly>
