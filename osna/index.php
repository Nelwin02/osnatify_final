        ...
        <div class="container py-5">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card text-center shadow h-100"  onclick="window.location.href='http://osnatify-j1a3.onrender.com/admin/login.php';" style="cursor: pointer;">
                        <div class="card-body">
                ...
                <!-- Clerk Login -->
                <div class="col-md-4 mb-3">
                    <div class="card text-center shadow h-100" onclick="location.href='http://osnatify-j1a3.onrender.com/clerk/login.php';" style="cursor: pointer;">
                        <div class="card-body">
                ...
                <!-- Doctor Login -->
                <div class="col-md-4 mb-3">
                    <div class="card text-center shadow h-100" onclick="location.href='http://osnatify-j1a3.onrender.com/doctor2/login.php';" style="cursor: pointer;">
                        <div class="card-body">
